...
var myCursor = document.getElementById("cursor"); // Calculation for custom cursor translate position

var CursorFollow = function CursorFollow(e) {
  myCursor.style.transform = "translate(".concat(e.clientX - myCursor.clientWidth / 2, "px, ").concat(e.clientY + window.scrollY - myCursor.clientHeight / 2, "px)");
}; // Calculate custom cursor position on scroll/wheel


document.addEventListener("wheel", function (e) {
  CursorFollow(e);
  var scrollDistance = e.deltaY; // Change in scroll

  var cursorTranslate = myCursor.style.transform; // Get curso translate properties

  var resY = cursorTranslate.split("px")[1];
  var resX = cursorTranslate.split(", ");
  var translateX = resX[0].split("translate(")[1].split("px")[0]; // Split to get X translate property

  var translateY = resY.split(", ")[1]; // Split to get Y translate property
  // Subtract scroll distance to translate Y property to get new cursor position after scroll

  myCursor.style.transform = "translate(".concat(translateX, "px, ").concat(translateY - scrollDistance, "px)");
});
document.addEventListener("mousemove", function (e) {
  ...
  for (var i = 0; i < cards.length; i++) {
    cards[i].style.transform = "rotate(-5deg) translateX(".concat(-strokeMove * (i + 1) + "px", ") translateY(").concat(strokeMove * (i + 1) + "px", ")");
  }

  CursorFollow(e);
}); // link hover animation to shrink cursor size

var links = document.getElementsByTagName("a"); // console.log(links);

var _loop = function _loop(i) {
  var link = links[i]; // Shrink cursor on mouse over

  link.addEventListener("mouseover", function (e) {
    console.log(e.target, myCursor);
    myCursor.style.width = "4px";
    myCursor.style.height = "4px"; // Get dimenstion and location of the link

    var shape = link.getBoundingClientRect();
    myCursor.style.transform = "translate(".concat(shape.x, "px, ").concat(shape.y, "px)");
...
},{"scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"}],"js/animations/account.js":[function(require,module,exports) {
"use strict";
...
var accountTl = new _gsap.TimelineMax({
  paused: true
});
accountTl.from(".switch-account .content", 0.5, {
  scaleX: 0
}).from(".switch-account h1", 0.5, {
  y: 20,
  opacity: 0
}, "+=0.5").staggerFrom(".switch-account li", 0.5, {
  y: 100,
  opacity: 0
}, 0.1).staggerFrom(".switch-account .card", 0.3, {
  y: 100,
  opacity: 0
}, 0.1).from(".switch-account .info", 0.3, {
  y: 10,
  opacity: 0
}, "+=0.5");
var accountController = new _scrollmagic.default.Controller({
  addIndicators: true
});
var accountScene = new _scrollmagic.default.Scene({
...
},{}],"js/animations/hero.js":[function(require,module,exports) {
"use strict";
...
var heroHeading = new SplitType(".hero-content h1", {
  split: "lines"
});
var heroCaption = new SplitType(".hero-content p", {
  split: "lines"
}); //Animation for Hero frame

var heroAnimation = new _gsap.TimelineMax();
heroAnimation.set(".phone-bg", {
  transformOrigin: "left center",
  scaleX: 0
}).from(".phone-bg", 1, {
  scaleX: 0,
  ease: Back.easeOut.config(1.2)
}, 1).staggerFrom(heroHeading.lines, 1, {
  y: 20,
  opacity: 0,
  ...
  opacity: 0,
  ease: Back.easeOut.config(1.7)
}).staggerFrom(heroCaption.lines, 0.5, {
  y: 20,
  opacity: 0,
  ease: Back.easeOut.config(1.7)
}, 0.05).from(".hero-content .button", 1, {
  y: 10,
  opacity: 0,
  ease: Back.easeOut.config(1.7)
}).from(".navigation", 0.3, {
  y: -10,
  opacity: 0,
  ease: _gsap.Power2.easOut
});
console.log(heroHeading.lines);
},{"gsap":"node_modules/gsap/index.js","scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js","typesplit":"node_modules/typesplit/splittype.js"}],"js/animations/why.js":[function(require,module,exports) {
"use strict";
...
var whyTl = new _gsap.TimelineMax({
  paused: true
});
whyTl.from(".why-switch .bg-rect", 0.5, {
  scaleX: 0
}).from(".why-switch h1", 0.5, {
  y: 20,
  opacity: 0
  ...
  ease: Power4.easeOut
}).staggerFrom(".reasons li", 0.5, {
  y: 100,
  opacity: 0
}, 0.1);
var whyController = new _scrollmagic.default.Controller({
  addIndicators: false
});
var whyScene = new _scrollmagic.default.Scene({
...
},{"gsap":"node_modules/gsap/index.js","scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"}],"index.js":[function(require,module,exports) {
"use strict";

require("./js/cursor");

require("./js/animations/account");

require("./js/animations/hero");

require("./js/animations/why");
},{"./js/cursor":"js/cursor.js","./js/animations/account":"js/animations/account.js","./js/animations/hero":"js/animations/hero.js","./js/animations/why":"js/animations/why.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/switch-landing.e31bb0bc.js.map